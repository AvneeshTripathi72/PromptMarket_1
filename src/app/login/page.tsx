...
export default function Login() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    if (
      ...
      password === process.env.NEXT_PUBLIC_TRIAL_ADMIN_PASSWORD
    ) {
      // Set a cookie manually for the "session"
      document.cookie = `trial_session=true; path=/; max-age=3600; samesite=lax`;
      router.push('/profile');
      setLoading(false);
      return;
    }
    ...
    <div className="min-h-[80vh] flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-black tracking-tight text-slate-900 mb-3">Welcome Back</h1>
          <p className="text-slate-500 font-medium text-lg">Enter your credentials to access the marketplace.</p>
        </div>
        ...
        <div className="bg-white rounded-[2.5rem] shadow-card border border-slate-100 p-10 relative overflow-hidden">
          ...
          <form onSubmit={handleSignIn} className="space-y-8">
            ...
            <div className="space-y-3">
              <label className="text-xs font-bold uppercase tracking-widest text-slate-400 ml-1">Secret Password</label>
              <div className="relative group">
            ...
            <div className="flex flex-col gap-6 pt-4">
              ...
              <div className="pt-8 border-t border-slate-50 flex flex-col items-center gap-4">
                <p className="text-slate-500 font-medium">
                  ...
                  <Link href="/register" className="ml-2 text-primary font-bold hover:underline underline-offset-4">Create Account</Link>
                </p>
              </div>
            </div>
          </form>
